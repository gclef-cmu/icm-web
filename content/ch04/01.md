...
In [Chapter 3](../ch03/index.md), we studied additive synthesis, with a goal of combining harmonics into richer sounds, or {vocab}`timbre`s (pronounced like the first two syllables of "tambourine").
