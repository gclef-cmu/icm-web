...
### Piazza
Piazza is our class discussion forum where we will post announcements, answer your questions, and provide any helpful exam materials. At the start of the semester you should have been invited to join our Piazza forum via email. If you didn't get this email, please contact course staff at [icm-csd@cmu.edu](mailto:icm-csd@cmu.edu).
...
2. Get an API key from https://freesound.org/apiv2/apply/. You can revisit this link anytime you want to view your credentials
When you first call `fetch_freesound`, enter your API client id and secret. This is cached locally so you usually don't have to do this again.
